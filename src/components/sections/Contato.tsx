...
export function Contato() {
  return (
    <Section id="contato" className="relative overflow-hidden bg-background-alt">
      {/* Glow radial */}
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
        <div className="h-[500px] w-[500px] rounded-full bg-accent-blue opacity-[0.05] blur-[100px]" />
      </div>
